...
PARAM$experimento <- "HT4510-edit-6"
...
hs <- makeParamSet(
  ...
  makeIntegerParam("min_data_in_leaf", lower = 500L, upper = 4000L),
  makeIntegerParam("num_leaves", lower = 256L, upper = 1024L),
  makeIntegerParam("envios", lower = 10000L, upper = 15000L),
  makeNumericParam("lambda_l1", lower = 0, upper = 1000),
  makeNumericParam("lambda_l2", lower = 0, upper = 1000),
  makeIntegerParam("max_bin", lower = 1L, upper = 512L)
)
...
EstimarGanancia_lightgbm <- function(x) {
  ...
  param_basicos <- list(
    ...
    # lambda_l1 = 0.05, # por ahora, lo dejo fijo
    # lambda_l2 = 0.01, # por ahora, lo dejo fijo
    # max_bin = 4, # por ahora, lo dejo fijo
    num_iterations = 999, # valor grande, lo limita early_stopping_rounds
